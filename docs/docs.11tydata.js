...
<meta property="og:image" content="/assets/images/og-images/docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li  >
      <a class="menu-link" href="/docs/robonomics-smart-home-overview">Overview</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/install-smart-home">Install Smart Home</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/hass-init">Home Assistant Init</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Add devices</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/docs/zigbee-devices">Zigbee Devices</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/virtual-devices">Virtual Devices</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/docs/sub-activate/?topic=smart-home">Subscription Activate</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/docs/robonomics-hass-integration/?topic=smart-home">Robonomics Integration Setup</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Advanced Setup</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Upgrade Home Assistant OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/docs/sub-activate/?topic=upgrade-home assistant os">Subscription Activate</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/hass-os-upgrade">Robonomics Installation</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Robonomics Integration Setup</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Upgrade Home Assistant Docker for Unix-like OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Subscription Activate</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Robonomics Installation</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Robonomics Integration Setup</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Upgrade Home Assistant Core</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/docs/sub-activate/?topic=upgrade-home assistant core">Subscription Activate</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Robonomics Installation</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Robonomics Integration Setup</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Use</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/docs/add-user">Add User</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/smart-home-telemetry">Get Smart Home Telemetry</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/backup-services">Backup Services</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/robonomics-video">Robonomics Video Service</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/ptz-camera">Rtz Camera Control in Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/pinata-setup">Pinata Setup</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/on-chain-gov-experiment">Оn-Chain Gov Experiment</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Blueprints</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/docs/use-blueprints">How To Use Blueprints</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/door-notification">Get Notified When Door Opens</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomics Devices</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/docs/ir-controller">IR Remote</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/energy-monitoring">Energy Monitoring</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/1gang-smart-switch">1 Gang Smart Switch</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/2gang-smart-switch">2 Gang Smart Switch</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/sds-sensor-connect">Air Quality Sensor</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomics Parachain Theory</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/docs/glossary">Glossary</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/create-account-in-dapp">Create Account for Robonomics Parachain</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/run-dev-node">How to Run Robonomics Dev Node</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/adding-funds-to-account-in-dapp">Adding Funds To Your Account on Robonomics Portal</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/datalog">Basics: Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/launch">Basics: Launch</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/digital-twins">Basics: Digital Twins</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/liability">Basics: Liability</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/rinterface">Python interface and Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/get-subscription">RWS: How to Buy a Subscription</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/subscription-launch">RWS: How to Send Launch with Subscription</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/robonomics-ethereum">Robonomics on Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/how-to-build-collator-node">How to build collator node from source</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/how-to-launch-the-robonomics-collator">How to launch the Robonomics collator</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/how-to-update-collator-node-version">How to Update Collator Node Version</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/esp32-datalog-demo">How to send extrinsic from ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/edit-wiki">How to Edit Wiki</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/docs/contributing">How to Contribute</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">Couldn&#39;t complete</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/docs/docs.11tydata.js"
        />
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">It was hard</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">It was ok</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">It was easy</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Connect+sensor"> Create an issue</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/docs/edit-wiki/">
             How to edit Wiki
            </a>
          </li>
          <li class="footer__item">
