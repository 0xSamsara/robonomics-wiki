...
<meta property="og:image" content="/assets/images/og-images/pt-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/pt-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Casa Inteligente</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/robonomics-smart-home-overview">Visão Geral</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/install-smart-home">Instalar Casa Inteligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/hass-init">Inicialização do Assistente Doméstico</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Adicionar dispositivos</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/zigbee-devices">Dispositivos Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/virtual-devices">Dispositivos Virtuais</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/pt/docs/sub-activate/?topic=smart-home">Ativar Assinatura</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/pt/docs/robonomics-hass-integration/?topic=smart-home">Configuração de Integração Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Configuração Avançada</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Atualizar Home Assistant OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/pt/docs/sub-activate/?topic=upgrade-home assistant os">Ativar Assinatura</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/hass-os-upgrade">Instalação do Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/pt/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Configuração de Integração Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Atualizar Home Assistant Docker para SO semelhante ao Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/pt/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Ativar Assinatura</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/pt/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Instalação do Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/pt/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Configuração de Integração Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Atualizar Home Assistant Core</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/pt/docs/sub-activate/?topic=upgrade-home assistant core">Ativar Assinatura</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/pt/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Instalação do Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/pt/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Configuração de Integração Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Usar</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/add-user">Adicionar Usuário</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/smart-home-telemetry">Obter Telemetria da Casa Inteligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/backup-services">Serviços de Backup</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/robonomics-video">Serviço de Vídeo Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/ptz-camera">Controle de Câmera Rtz no Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/pinata-setup">Configuração da Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/on-chain-gov-experiment">Experimento de Governança On-Chain</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Projetos</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/use-blueprints">Como Usar Projetos</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/door-notification">Receber Notificação Quando a Porta Abrir</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Dispositivos Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/ir-controller">Controle Remoto IR</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/energy-monitoring">Monitoramento de Energia</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/1gang-smart-switch">Interruptor Inteligente de 1 Gangue</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/2gang-smart-switch">Interruptor Inteligente de 2 Gangues</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/sds-sensor-connect">Sensor de Qualidade do Ar</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Teoria da Parachain Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/glossary">Glossário</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/create-account-in-dapp">Criar Conta para Parachain Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/run-dev-node">Como Executar um Nó de Desenvolvimento Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/adding-funds-to-account-in-dapp">Adicionando Fundos à Sua Conta no Portal Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/datalog">Fundamentos: Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/launch">Fundamentos: Lançamento</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/digital-twins">Fundamentos: Gêmeos Digitais</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/liability">Fundamentos: Responsabilidade</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/rinterface">Interface Python e Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/get-subscription">RWS: Como Comprar uma Assinatura</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/subscription-launch">RWS: Como Enviar um Lançamento com Assinatura</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/robonomics-ethereum">Robonomics no Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/how-to-build-collator-node">Como Construir um Nó Colator a partir da Fonte</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/how-to-launch-the-robonomics-collator">Como lançar o colator Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/how-to-update-collator-node-version">Como Atualizar a Versão do Nó Colator</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/esp32-datalog-demo">Como enviar extrínseco do ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/edit-wiki">Como Editar a Wiki</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/pt/docs/contributing">Como Contribuir</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">Não foi possível concluir</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/pt/docs/docs.11tydata.js"
        />
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Enviando suas informações...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Obrigado,<br/> Vamos manter contato! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">Foi difícil</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">Estava tudo bem.</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">Foi fácil</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Receba+Notifica%C3%A7%C3%B5es+Quando+a+Porta+Abrir"> Criar um problema</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/pt/docs/edit-wiki/">
             Como editar o Wiki
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/pt/privacy-policy/">
          ...
          <div class="footer-text">
            <span class=""> A tradução foi feita por IA, então pode haver algumas imprecisões </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Por favor, informe-nos. </a>, por favor, se encontrar algum
          </div>
