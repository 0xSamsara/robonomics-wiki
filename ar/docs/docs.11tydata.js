...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >المنزل الذكي</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/robonomics-smart-home-overview">نظرة عامة</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/install-smart-home">تثبيت المنزل الذكي</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/hass-init">بدء مساعد المنزل</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >إضافة الأجهزة</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/zigbee-devices">أجهزة زيغبي</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/virtual-devices">أجهزة افتراضية</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/ar/docs/sub-activate/?topic=smart-home">تنشيط الاشتراك</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ar/docs/robonomics-hass-integration/?topic=smart-home">إعداد دمج Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >إعداد متقدم</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >ترقية نظام التشغيل المساعد للمنزل</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ar/docs/sub-activate/?topic=upgrade-home assistant os">تنشيط الاشتراك</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/hass-os-upgrade">تثبيت Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ar/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">إعداد دمج Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >ترقية مساعد المنزل Docker لنظام التشغيل شبيه بيونكس</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ar/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">تنشيط الاشتراك</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ar/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">تثبيت Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ar/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">إعداد دمج Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >ترقية مساعد المنزل الأساسي</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/ar/docs/sub-activate/?topic=upgrade-home assistant core">تنشيط الاشتراك</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ar/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">تثبيت Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ar/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">إعداد دمج Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >استخدام</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/add-user">إضافة مستخدم</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/smart-home-telemetry">الحصول على بيانات تلميتري للمنزل الذكي</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/backup-services">خدمات النسخ الاحتياطي</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/robonomics-video">خدمة فيديو Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/ptz-camera">التحكم في كاميرا Rtz في مساعد المنزل</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/pinata-setup">إعداد بيناتا</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/on-chain-gov-experiment">تجربة حكومية على السلسلة</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >المخططات</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/use-blueprints">كيفية استخدام المخططات</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/door-notification">احصل على إشعار عند فتح الباب</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >أجهزة Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/ir-controller">جهاز التحكم عن بعد بالأشعة تحت الحمراء</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/energy-monitoring">مراقبة الطاقة</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/1gang-smart-switch">مفتاح ذكي لمجموعة 1</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/2gang-smart-switch">مفتاح ذكي لمجموعة 2</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/sds-sensor-connect">جهاز استشعار جودة الهواء</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >نظرية سلسلة القفزات Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/glossary">قاموس المصطلحات</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/create-account-in-dapp">إنشاء حساب لسلسلة القفزات Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/run-dev-node">كيفية تشغيل عقدة تطوير Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/adding-funds-to-account-in-dapp">إضافة أموال إلى حسابك على بوابة Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/datalog">الأساسيات: بيانات السجل</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/launch">الأساسيات: الإطلاق</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/digital-twins">الأساسيات: التوائم الرقمية</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/liability">الأساسيات: المسؤولية</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/rinterface">واجهة Python و Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/get-subscription">RWS: كيفية شراء اشتراك</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/subscription-launch">RWS: كيفية إرسال إطلاق مع الاشتراك</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/robonomics-ethereum">Robonomics على إيثيريوم</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/how-to-build-collator-node">كيفية بناء عقدة جامع من المصدر</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/how-to-launch-the-robonomics-collator">كيفية تشغيل عقدة جامع Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/how-to-update-collator-node-version">كيفية تحديث إصدار عقدة الجامع</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/esp32-datalog-demo">كيفية إرسال خارجي من ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/edit-wiki">كيفية تحرير الويكي</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ar/docs/contributing">كيفية المساهمة</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">لم يتم الانتهاء</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/ar/docs/docs.11tydata.js"
        />
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>شكرًا،<br/> سنبقى على اتصال! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">كانت صعبة</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">كانت على ما يرام</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">كانت سهلة</label>
      </div>
    </button>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/ar/docs/edit-wiki/">
             كيفية تحرير الويكي
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/ar/privacy-policy/">
              سياسة الخصوصية
            </a>
          </li>
        </ul>
          ...
          <div class="footer-text">
            <span class=""> تم تنفيذ الترجمة بواسطة الذكاء الاصطناعي لذا قد تكون هناك بعض الاخطاء </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> أخبرنا </a>, من فضلك، إذا وجدت أي شيء
          </div>
