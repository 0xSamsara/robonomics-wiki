...
<meta property="og:image" content="/assets/images/og-images/es-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/es-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Hogar Inteligente</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/robonomics-smart-home-overview">Visión general</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/install-smart-home">Instalar Hogar Inteligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/hass-init">Inicio del Asistente de Hogar</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Agregar dispositivos</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/zigbee-devices">Dispositivos Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/virtual-devices">Dispositivos Virtuales</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/es/docs/sub-activate/?topic=smart-home">Activar Suscripción</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/es/docs/robonomics-hass-integration/?topic=smart-home">Configuración de Integración de Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Configuración Avanzada</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Actualizar Home Assistant OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/es/docs/sub-activate/?topic=upgrade-home assistant os">Activar Suscripción</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/hass-os-upgrade">Instalación de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/es/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Configuración de Integración de Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Actualizar Home Assistant Docker para OS tipo Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/es/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Activar Suscripción</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/es/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Instalación de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/es/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Configuración de Integración de Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Actualizar Home Assistant Core</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/es/docs/sub-activate/?topic=upgrade-home assistant core">Activar Suscripción</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/es/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Instalación de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/es/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Configuración de Integración de Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Uso</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/add-user">Agregar Usuario</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/smart-home-telemetry">Obtener Telemetría del Hogar Inteligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/backup-services">Servicios de Respaldo</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/robonomics-video">Servicio de Video de Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/ptz-camera">Control de Cámara Rtz en Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/pinata-setup">Configuración de Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/on-chain-gov-experiment">Experimento de Gobierno en Cadena</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Planos</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/use-blueprints">Cómo Usar Planos</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/door-notification">Recibir Notificación Cuando se Abre la Puerta</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Dispositivos de Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/ir-controller">Control Remoto IR</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/energy-monitoring">Monitoreo de Energía</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/1gang-smart-switch">Interruptor Inteligente de 1 Canal</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/2gang-smart-switch">Interruptor Inteligente de 2 Canales</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/sds-sensor-connect">Sensor de Calidad del Aire</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Teoría de la Paracadena de Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/es/docs/glossary">Glosario</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/create-account-in-dapp">Crear Cuenta para la Paracadena de Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/run-dev-node">Cómo Ejecutar un Nodo de Desarrollo de Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/adding-funds-to-account-in-dapp">Agregar Fondos a tu Cuenta en el Portal de Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/datalog">Conceptos Básicos: Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/launch">Conceptos Básicos: Lanzamiento</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/digital-twins">Conceptos Básicos: Gemelos Digitales</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/liability">Conceptos Básicos: Responsabilidad</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/rinterface">Interfaz Python y Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/get-subscription">RWS: Cómo Comprar una Suscripción</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/subscription-launch">RWS: Cómo Enviar un Lanzamiento con Suscripción</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/robonomics-ethereum">Robonomics en Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/how-to-build-collator-node">Cómo construir un nodo de colación desde la fuente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/how-to-launch-the-robonomics-collator">Cómo lanzar el colador de Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/how-to-update-collator-node-version">Cómo Actualizar la Versión del Nodo Colador</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/esp32-datalog-demo">Cómo enviar extrínsecos desde ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/edit-wiki">Cómo Editar Wiki</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/es/docs/contributing">Cómo Contribuir</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">No se pudo completar</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/es/docs/docs.11tydata.js"
        />
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Enviando tu información...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Gracias,<br/> ¡Nos mantendremos en contacto! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">Fue difícil</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">Estuvo bien.</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">Fue fácil</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Datalog"> Crear un problema</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/es/docs/edit-wiki/">
             Cómo editar el Wiki
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/es/privacy-policy/">
          ...
          <div class="footer-text">
            <span class=""> La traducción fue realizada por inteligencia artificial, por lo que puede haber algunas imprecisiones </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Infórmanos </a>, por favor, si encuentras alguno
          </div>
