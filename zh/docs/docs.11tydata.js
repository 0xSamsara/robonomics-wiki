...
<meta property="og:image" content="/assets/images/og-images/zh-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/zh-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >智能家居</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/robonomics-smart-home-overview">概览</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/install-smart-home">安装智能家居</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/hass-init">Home Assistant 初始化</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >添加设备</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/zigbee-devices">Zigbee 设备</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/virtual-devices">虚拟设备</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/zh/docs/sub-activate/?topic=smart-home">订阅激活</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/zh/docs/robonomics-hass-integration/?topic=smart-home">Robonomics 集成设置</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >高级设置</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >升级 Home Assistant 操作系统</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/zh/docs/sub-activate/?topic=upgrade-home assistant os">订阅激活</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/hass-os-upgrade">Robonomics 安装</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/zh/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Robonomics 集成设置</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >升级 Unix-like 操作系统的 Home Assistant Docker</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/zh/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">订阅激活</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/zh/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Robonomics 安装</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/zh/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Robonomics 集成设置</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >升级 Home Assistant 核心</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/zh/docs/sub-activate/?topic=upgrade-home assistant core">订阅激活</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/zh/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Robonomics 安装</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/zh/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Robonomics 集成设置</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >使用</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/add-user">添加用户</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/smart-home-telemetry">获取智能家居遥测数据</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/backup-services">备份服务</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/robonomics-video">Robonomics 视频服务</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/ptz-camera">在 Home Assistant 中控制 Rtz 摄像头</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/pinata-setup">Pinata 设置</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/on-chain-gov-experiment">链上治理实验</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >蓝图</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/use-blueprints">如何使用蓝图</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/door-notification">门打开时收到通知</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomics 设备</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/ir-controller">红外遥控器</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/energy-monitoring">能源监测</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/1gang-smart-switch">1键智能开关</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/2gang-smart-switch">2键智能开关</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/sds-sensor-connect">空气质量传感器</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomics 平行链理论</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/glossary">术语表</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/create-account-in-dapp">为 Robonomics 平行链创建账户</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/run-dev-node">如何运行 Robonomics 开发节点</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/adding-funds-to-account-in-dapp">在 Robonomics 门户网站上为您的账户添加资金</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/datalog">基础知识：数据日志</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/launch">基础知识：启动</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/digital-twins">基础知识：数字孪生</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/liability">基础知识：责任</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/rinterface">Python 接口和 Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/get-subscription">RWS：如何购买订阅</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/subscription-launch">RWS：如何使用订阅发送启动</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/robonomics-ethereum">Robonomics 在以太坊上</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/robonomics-opengov">Robonomics 开放式治理</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/how-to-build-collator-node">如何从源代码构建收集节点</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/how-to-launch-the-robonomics-collator">如何启动 Robonomics 收集节点</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/how-to-update-collator-node-version">如何更新收集节点版本</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/esp32-datalog-demo">如何从 ESP 发送外部数据</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/edit-wiki">如何编辑维基</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/zh/docs/contributing">如何贡献</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">无法完成</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/zh/docs/docs.11tydata.js"
        />
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">这很难</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">这很容易</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+%E6%95%B0%E5%AD%97%E5%AD%AA%E7%94%9F"> 创建一个问题</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/zh/docs/edit-wiki/">
             如何编辑维基
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/zh/privacy-policy/">
              隐私政策
            </a>
          </li>
        </ul>
          ...
          <div class="footer-text">
            <span class=""> 翻译由AI执行，可能存在一些不准确之处 </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> 请告知我们 </a>, 请，如果你找到任何
          </div>
