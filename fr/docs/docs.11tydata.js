...
<meta property="og:image" content="/assets/images/og-images/fr-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/fr-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Maison intelligente</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/robonomics-smart-home-overview">Aperçu</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/install-smart-home">Installer la maison intelligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/hass-init">Initialisation de l&#39;assistant domestique</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Ajouter des appareils</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/zigbee-devices">Appareils Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/virtual-devices">Appareils virtuels</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/fr/docs/sub-activate/?topic=smart-home">Activer l&#39;abonnement</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/fr/docs/robonomics-hass-integration/?topic=smart-home">Configuration de l&#39;intégration Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Configuration avancée</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Mise à niveau de Home Assistant OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/fr/docs/sub-activate/?topic=upgrade-home assistant os">Activer l&#39;abonnement</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/hass-os-upgrade">Installation de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/fr/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Configuration de l&#39;intégration Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Mise à niveau de Home Assistant Docker pour les systèmes d&#39;exploitation de type Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/fr/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Activer l&#39;abonnement</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/fr/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Installation de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/fr/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Configuration de l&#39;intégration Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Mise à niveau de Home Assistant Core</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/fr/docs/sub-activate/?topic=upgrade-home assistant core">Activer l&#39;abonnement</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/fr/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Installation de Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/fr/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Configuration de l&#39;intégration Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Utilisation</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/add-user">Ajouter un utilisateur</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/smart-home-telemetry">Obtenir la télémétrie de la maison intelligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/backup-services">Services de sauvegarde</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/robonomics-video">Service vidéo Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/ptz-camera">Contrôle de la caméra Rtz dans Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/pinata-setup">Configuration de Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/on-chain-gov-experiment">Expérience de gouvernance sur chaîne</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Plans</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/use-blueprints">Comment utiliser les plans</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/door-notification">Recevoir une notification lorsque la porte s&#39;ouvre</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Appareils Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/ir-controller">Télécommande infrarouge</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/energy-monitoring">Surveillance de l&#39;énergie</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/1gang-smart-switch">Interrupteur intelligent 1 gang</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/2gang-smart-switch">Interrupteur intelligent 2 gangs</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/sds-sensor-connect">Capteur de qualité de l&#39;air</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Théorie de la parachaine Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/glossary">Glossaire</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/create-account-in-dapp">Créer un compte pour la parachaine Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/run-dev-node">Comment exécuter un nœud de développement Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/adding-funds-to-account-in-dapp">Ajouter des fonds à votre compte sur le portail Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/datalog">Fondamentaux : Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/launch">Fondamentaux : Lancement</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/digital-twins">Fondamentaux : Jumeaux numériques</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/liability">Fondamentaux : Responsabilité</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/rinterface">Interface Python et Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/get-subscription">RWS : Comment acheter un abonnement</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/subscription-launch">RWS : Comment envoyer un lancement avec abonnement</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/robonomics-ethereum">Robonomics sur Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/how-to-build-collator-node">Comment construire un nœud collator à partir de la source</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/how-to-launch-the-robonomics-collator">Comment lancer le collator Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/how-to-update-collator-node-version">Comment mettre à jour la version du nœud collator</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/esp32-datalog-demo">Comment envoyer une extrinsèque depuis ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/edit-wiki">Comment éditer le wiki</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/fr/docs/contributing">Comment contribuer</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">Impossible à compléter</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/fr/docs/docs.11tydata.js"
        />
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Envoi de vos informations...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Merci,<br/> Nous resterons en contact ! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">C&#39;était difficile</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">C&#39;était correct</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">C&#39;était facile</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Comment+acheter+un+abonnement"> Créer un problème</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/fr/docs/edit-wiki/">
             Comment éditer le Wiki
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/fr/privacy-policy/">
          ...
          <div class="footer-text">
            <span class=""> La traduction a été effectuée par une IA, il peut donc y avoir des inexactitudes </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Nous informer </a>, s&#39;il vous plaît, si vous en trouvez
          </div>
