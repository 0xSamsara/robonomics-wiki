...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >스마트 홈</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/robonomics-smart-home-overview">개요</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/install-smart-home">스마트 홈 설치</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/hass-init">홈 어시스턴트 초기화</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >장치 추가</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/zigbee-devices">지그비 장치</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/virtual-devices">가상 장치</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/ko/docs/sub-activate/?topic=smart-home">구독 활성화</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ko/docs/robonomics-hass-integration/?topic=smart-home">로보노믹스 통합 설정</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >고급 설정</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >홈 어시스턴트 OS 업그레이드</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ko/docs/sub-activate/?topic=upgrade-home assistant os">구독 활성화</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/hass-os-upgrade">로보노믹스 설치</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ko/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">로보노믹스 통합 설정</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >유닉스류 OS용 홈 어시스턴트 도커 업그레이드</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ko/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">구독 활성화</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ko/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">로보노믹스 설치</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ko/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">로보노믹스 통합 설정</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >홈 어시스턴트 코어 업그레이드</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/ko/docs/sub-activate/?topic=upgrade-home assistant core">구독 활성화</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ko/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">로보노믹스 설치</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ko/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">로보노믹스 통합 설정</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >사용</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/add-user">사용자 추가</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/smart-home-telemetry">스마트 홈 텔레메트리 가져오기</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/backup-services">백업 서비스</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/robonomics-video">로보노믹스 비디오 서비스</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/ptz-camera">홈 어시스턴트에서 RTZ 카메라 제어</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/pinata-setup">피나타 설정</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/on-chain-gov-experiment">체인 내 정부 실험</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >청사진</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/use-blueprints">청사진 사용 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/door-notification">문이 열릴 때 알림 받기</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >로보노믹스 장치</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/ir-controller">IR 원격</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/energy-monitoring">에너지 모니터링</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/1gang-smart-switch">1 갱 스마트 스위치</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/2gang-smart-switch">2 갱 스마트 스위치</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/sds-sensor-connect">공기 질 센서</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >로보노믹스 파라체인 이론</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/glossary">용어집</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/create-account-in-dapp">로보노믹스 파라체인을 위한 계정 생성</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/run-dev-node">로보노믹스 개발 노드 실행 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/adding-funds-to-account-in-dapp">로보노믹스 포털의 계정에 자금 추가하는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/datalog">기본 사항: 데이터 로그</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/launch">기본 사항: 런치</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/digital-twins">기본 사항: 디지털 트윈</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/liability">기본 사항: 책임</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/rinterface">파이썬 인터페이스 및 로보노믹스 IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/get-subscription">RWS: 구독 구매 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/subscription-launch">RWS: 구독과 함께 런치 보내는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/robonomics-ethereum">이더리움에서의 로보노믹스</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/robonomics-opengov">로보노믹스 오픈 정부</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/how-to-build-collator-node">소스로부터 콜레이터 노드 빌드하는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/how-to-launch-the-robonomics-collator">로보노믹스 콜레이터 실행하는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/how-to-update-collator-node-version">콜레이터 노드 버전 업데이트하는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/esp32-datalog-demo">ESP에서 외부를 보내는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/edit-wiki">위키 편집하는 방법</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ko/docs/contributing">기여하는 방법</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">완료할 수 없습니다</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/ko/docs/docs.11tydata.js"
        />
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">어려웠어요</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">괜찮았어요</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">쉬웠어</label>
      </div>
    </button>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/ko/docs/edit-wiki/">
             위키 편집 방법
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/ko/privacy-policy/">
              개인정보 보호 정책
            </a>
          </li>
        </ul>
          ...
          <div class="footer-text">
            <span class=""> 번역은 AI에 의해 실행되었으므로 일부 부정확성이 있을 수 있습니다 </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> 알려주세요 </a>, 찾으면 알려주세요.
          </div>
