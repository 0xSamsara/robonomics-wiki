...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >スマートホーム</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/robonomics-smart-home-overview">概要</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/install-smart-home">スマートホームのインストール</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/hass-init">ホームアシスタントの初期化</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >デバイスの追加</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/zigbee-devices">Zigbeeデバイス</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/virtual-devices">仮想デバイス</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/ja/docs/sub-activate/?topic=smart-home">サブスクリプションの有効化</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ja/docs/robonomics-hass-integration/?topic=smart-home">Robonomics 統合のセットアップ</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >高度なセットアップ</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Home Assistant OSのアップグレード</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ja/docs/sub-activate/?topic=upgrade-home assistant os">サブスクリプションの有効化</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/hass-os-upgrade">Robonomicsのインストール</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ja/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Robonomics 統合のセットアップ</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Unix系OS用のHome Assistant Dockerのアップグレード</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ja/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">サブスクリプションの有効化</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ja/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Robonomicsのインストール</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ja/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Robonomics 統合のセットアップ</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Home Assistant Coreのアップグレード</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/ja/docs/sub-activate/?topic=upgrade-home assistant core">サブスクリプションの有効化</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ja/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Robonomicsのインストール</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ja/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Robonomics 統合のセットアップ</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li  >
      <a class="menu-link" href="/ja/docs/add-user">ユーザーの追加</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/smart-home-telemetry">スマートホームのテレメトリーを取得</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/backup-services">バックアップサービス</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/robonomics-video">Robonomicsビデオサービス</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/ptz-camera">Home AssistantでのRtzカメラ制御</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/pinata-setup">Pinataのセットアップ</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/on-chain-gov-experiment">オンチェーンガバナンス実験</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >設計図</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/use-blueprints">設計図の使用方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/door-notification">ドアが開いたときに通知を受け取る</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomicsデバイス</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/ir-controller">IRリモート</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/energy-monitoring">エネルギーモニタリング</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/1gang-smart-switch">1ギャングスマートスイッチ</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/2gang-smart-switch">2ギャングスマートスイッチ</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/sds-sensor-connect">空気品質センサー</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Robonomicsパラチェーン理論</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/glossary">用語集</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/create-account-in-dapp">Robonomicsパラチェーン用のアカウントを作成</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/run-dev-node">Robonomics Devノードの実行方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/adding-funds-to-account-in-dapp">Robonomicsポータルのアカウントに資金を追加する方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/datalog">基本: データログ</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/launch">基本: ローンチ</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/digital-twins">基本: デジタルツイン</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/liability">基本: 責任</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/rinterface">PythonインターフェースとRobonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/get-subscription">RWS: サブスクリプションの購入方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/subscription-launch">RWS: サブスクリプション付きのローンチの送信方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/robonomics-ethereum">Ethereum上のRobonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/how-to-build-collator-node">ソースからコレーターノードを構築する方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/how-to-launch-the-robonomics-collator">Robonomicsコレーターの起動方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/how-to-update-collator-node-version">コレーターノードバージョンの更新方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/esp32-datalog-demo">ESPから外部送信を行う方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/edit-wiki">ウィキの編集方法</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ja/docs/contributing">貢献方法</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">完了できませんでした</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/ja/docs/docs.11tydata.js"
        />
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">それは難しかったです</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">それは大丈夫でした</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">簡単でした</label>
      </div>
    </button>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/ja/docs/edit-wiki/">
             ウィキの編集方法
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/ja/privacy-policy/">
              プライバシーポリシー
            </a>
          </li>
        </ul>
          ...
          <div class="footer-text">
            <span class=""> 翻訳はAIによって実行されたため、いくつかの不正確さがあるかもしれません </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> お知らせください </a>, お願いします、もし見つけたら
          </div>
