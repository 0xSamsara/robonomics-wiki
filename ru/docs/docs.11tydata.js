...
<meta property="og:image" content="/assets/images/og-images/ru-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/ru-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Умный дом</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/robonomics-smart-home-overview">Обзор</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/install-smart-home">Установить умный дом</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/hass-init">Инициализация домашнего помощника</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Добавить устройства</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/zigbee-devices">Устройства Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/virtual-devices">Виртуальные устройства</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/ru/docs/sub-activate/?topic=smart-home">Активация подписки</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ru/docs/robonomics-hass-integration/?topic=smart-home">Настройка интеграции Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Расширенная настройка</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Обновление операционной системы Home Assistant</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ru/docs/sub-activate/?topic=upgrade-home assistant os">Активация подписки</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/hass-os-upgrade">Установка Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ru/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Настройка интеграции Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Обновление Home Assistant Docker для ОС Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/ru/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Активация подписки</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ru/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Установка Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ru/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Настройка интеграции Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Обновление ядра Home Assistant</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/ru/docs/sub-activate/?topic=upgrade-home assistant core">Активация подписки</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/ru/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Установка Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/ru/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Настройка интеграции Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Использование</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/add-user">Добавить пользователя</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/smart-home-telemetry">Получить телеметрию умного дома</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/backup-services">Сервисы резервного копирования</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/robonomics-video">Видеосервис Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/ptz-camera">Управление камерой Rtz в Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/pinata-setup">Настройка Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/on-chain-gov-experiment">Эксперимент с управлением на цепочке</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Чертежи</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/use-blueprints">Как использовать чертежи</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/door-notification">Получать уведомления при открытии двери</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Устройства Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/ir-controller">ИК-пульт</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/energy-monitoring">Мониторинг энергопотребления</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/1gang-smart-switch">1-канальный умный выключатель</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/2gang-smart-switch">2-канальный умный выключатель</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/sds-sensor-connect">Датчик качества воздуха</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Теория парачейна Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/glossary">Глоссарий</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/create-account-in-dapp">Создать аккаунт для парачейна Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/run-dev-node">Как запустить узел разработки Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/adding-funds-to-account-in-dapp">Добавление средств на ваш аккаунт в портале Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/datalog">Основы: Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/launch">Основы: Запуск</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/digital-twins">Основы: Цифровые двойники</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/liability">Основы: Ответственность</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/rinterface">Интерфейс Python и Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/get-subscription">RWS: Как купить подписку</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/subscription-launch">RWS: Как отправить запуск с подпиской</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/robonomics-ethereum">Robonomics на Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/how-to-build-collator-node">Как построить узел коллатора из исходного кода</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/how-to-launch-the-robonomics-collator">Как запустить коллатор Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/how-to-update-collator-node-version">Как обновить версию узла коллатора</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/esp32-datalog-demo">Как отправить экструзию из ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/edit-wiki">Как редактировать вики</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/ru/docs/contributing">Как внести вклад</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">Не удалось завершить</label>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/ru/docs/docs.11tydata.js"
        />
        ...
        <button class="robo-wiki-feedback-form__btn">
          <div class="robo-wiki-feedback-form__btn-wrapper robo-wiki-feedback-form__btn-wrapper--init">
            ...
            <span>Расскажите нам больше</span>
          </div>
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Отправляем вашу информацию...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Спасибо,<br/> Мы будем на связи! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">Это было трудно</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">Это было нормально</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">Это было легко</label>
      </div>
    </button>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/ru/docs/edit-wiki/">
          ...
          <div class="footer-text">
            <span class=""> Перевод был выполнен искусственным интеллектом, поэтому могут быть некоторые неточности </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Сообщите нам </a>, пожалуйста, если найдете что-либо
          </div>
