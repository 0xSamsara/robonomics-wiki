...
<meta property="og:image" content="/assets/images/og-images/it-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/it-docs-docs.11tydata.j.png">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Casa Intelligente</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/robonomics-smart-home-overview">Panoramica</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/install-smart-home">Installare Casa Intelligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/hass-init">Inizializzazione Assistente Domestico</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Aggiungi dispositivi</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/zigbee-devices">Dispositivi Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/virtual-devices">Dispositivi Virtuali</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/it/docs/sub-activate/?topic=smart-home">Attivazione Abbonamento</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/it/docs/robonomics-hass-integration/?topic=smart-home">Configurazione Integrazione Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Configurazione Avanzata</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Aggiornamento Home Assistant OS</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/it/docs/sub-activate/?topic=upgrade-home assistant os">Attivazione Abbonamento</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/hass-os-upgrade">Installazione Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/it/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Configurazione Integrazione Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Aggiornamento Home Assistant Docker per OS simili a Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/it/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Attivazione Abbonamento</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/it/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Installazione Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/it/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Configurazione Integrazione Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Aggiornamento Home Assistant Core</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/it/docs/sub-activate/?topic=upgrade-home assistant core">Attivazione Abbonamento</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/it/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Installazione Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/it/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Configurazione Integrazione Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Utilizzo</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/add-user">Aggiungi Utente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/smart-home-telemetry">Ottieni Telemetria Casa Intelligente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/backup-services">Servizi di Backup</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/robonomics-video">Servizio Video Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/ptz-camera">Controllo Fotocamera Rtz in Home Assistant</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/pinata-setup">Configurazione Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/on-chain-gov-experiment">Esperimento di Governance On-Chain</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Progetti</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/use-blueprints">Come Utilizzare i Progetti</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/door-notification">Ricevi una Notifica Quando la Porta si Apre</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Dispositivi Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/ir-controller">Telecomando IR</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/energy-monitoring">Monitoraggio dell&#39;Energia</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/1gang-smart-switch">Interruttore Smart a 1 Gang</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/2gang-smart-switch">Interruttore Smart a 2 Gang</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/sds-sensor-connect">Sensore di Qualità dell&#39;Aria</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Teoria della Parachain Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/it/docs/glossary">Glossario</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/create-account-in-dapp">Crea un Account per la Parachain Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/run-dev-node">Come Eseguire un Nodo Dev di Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/adding-funds-to-account-in-dapp">Aggiungere Fondi al Tuo Account sul Portale Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/datalog">Principi Fondamentali: Datalog</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/launch">Principi Fondamentali: Lancio</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/digital-twins">Principi Fondamentali: Gemelli Digitali</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/liability">Principi Fondamentali: Responsabilità</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/rinterface">Interfaccia Python e Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/get-subscription">RWS: Come Acquistare un Abbonamento</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/subscription-launch">RWS: Come Inviare un Lancio con Abbonamento</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/robonomics-ethereum">Robonomics su Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/how-to-build-collator-node">Come Costruire un Nodo Collator da Sorgente</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/how-to-launch-the-robonomics-collator">Come Lanciare il Collator Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/how-to-update-collator-node-version">Come Aggiornare la Versione del Nodo Collator</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/esp32-datalog-demo">Come Inviare Estrinsechi da ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/edit-wiki">Come Modificare il Wiki</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/it/docs/contributing">Come Contribuire</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-0">Non è stato possibile completare</label>
      </div>
    </button>
    ...
    <div class="robo-wiki-feedback-form__header">
      <div>
        ...
        <h3>Non è stato possibile completare</h3>
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/it/docs/docs.11tydata.js"
        />
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Invio delle tue informazioni...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Grazie,<br/> Rimarremo in contatto! </div>
    </div>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was hard">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-1">È stato difficile</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was ok">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-2">Andava bene</label>
      </div>
    </button>
    ...
    <button class="robo-wiki-feedback__item" data-text="It was easy">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <label for="checkbox-3">È stato facile</label>
      </div>
    </button>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Gemelli+Digitali"> Creare un problema</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/it/docs/edit-wiki/">
             Come modificare il Wiki
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/it/privacy-policy/">
          ...
          <div class="footer-text">
            <span class=""> La traduzione è stata eseguita da un&#39;intelligenza artificiale, quindi potrebbero esserci delle imprecisioni </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Informaci. </a>, per favore, se trovi qualcosa
          </div>
